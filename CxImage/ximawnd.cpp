...
bool CxImage::CreateFromHANDLE(HANDLE hMem)
{
	...
	if (lpVoid){
		...
		SetXDPI((int32_t)((head.biXPelsPerMeter * 254 + 5000) / 10000));
		SetYDPI((int32_t)((head.biYPelsPerMeter * 254 + 5000) / 10000));
...
void CxImage::InitTextInfo( CXTEXTINFO *txt )
{
    ...
    // initial colors
    txt->fcolor = RGB( 255,255,160 );  // default foreground: light gold-yellow
